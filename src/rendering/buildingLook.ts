...
export const BUILDING_SHAPES: Record<SilhouetteKey, readonly ShapePart[]> = {
  ...
  belt: [],
  composer: [
    { part: "chamber", x: 0, y: 0, scale: 0.34 },
    {
      part: "band",
      x: 0,
      y: -0.16,
  ...
  smelting: [
    ...
    { part: "stack", x: 0.22, y: -0.3, scale: 0.13, material: "dark" },
  ],
  firing: [
    { part: "vessel", x: 0, y: 0.04, scale: 0.37 },
    {
      part: "aperture",
      x: 0,
      y: 0.08,
  ...
  cutting: [
    { part: "rotor", x: 0, y: -0.12, scale: 0.3, count: 1, phase: "spin" },
  ...
  pump: [
    { part: "vessel", x: 0, y: -0.02, scale: 0.28 },
    { part: "stack", x: 0, y: -0.22, scale: 0.13, rotation: Math.PI },
    {
      part: "aperture",
      x: 0,
      y: -0.38,
  ...
  pole: [{ part: "mast", x: 0, y: 0, scale: 0.62 }],
  generator: [{ part: "chamber", x: 0, y: 0, scale: 0.32 }],
  burner: [
    {
      part: "vessel",
      x: 0,
  ...
  hydro: [{ part: "rotor", x: 0, y: 0, scale: 0.34, count: 4, phase: "spin" }],
  turbine: [
    { part: "rotor", x: 0, y: -0.08, scale: 0.32, count: 6, phase: "spin" },
    { part: "stack", x: 0, y: -0.36, scale: 0.13, material: "dark" },
    {
      part: "aperture",
      x: 0,
      y: -0.5,
  ...
  boiler: [
    { part: "vessel", x: 0, y: 0.02, scale: 0.37 },
    {
      part: "aperture",
      x: -0.08,
      y: -0.38,
