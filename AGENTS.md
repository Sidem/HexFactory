...
Current release: **v0.25.1 Junctions**. Next: **Living Lattice v0.26** in
`docs/HEXFACTORY-PLAN.md`. Envelopes: save 14, definitions 14, technologies 7, scenarios 5, world 8,
wire 9.
