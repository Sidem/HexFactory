...
- `src/core/FactoryHost.ts` — 379 lines / 11.1 KiB — FactoryWorkerMethod:25, WorldChoice:43, FactoryTransport:45, WorkerTransport:65, …
...
- `src/core/commands.ts` — 323 lines / 10.5 KiB — EncodedCommand:3, MAX_AIM_COORDINATE:13, halfTransfer:23, encodeCommand:35
...
- `src/core/factory.worker.ts` — 218 lines / 7.8 KiB — handle:53, requireFactory:181, delta:194, optionalNumber:205, …
...
- `src/core/saveSlots.ts` — 791 lines / 24.9 KiB — SAVE_VERSION:38, SAVE_CATALOG_KEY:39, LEGACY_SAVE_PREFIX:40, HXF1_PREFIX:41, …
- `src/core/skills.ts` — 101 lines / 3.8 KiB — validateSkills:4
- `src/core/snapshotDelta.ts` — 130 lines / 4.6 KiB — applySnapshotDelta:12, applyBuildingsPatch:46, applyResourcesPatch:83, applyTerrainPatch:106, …
...
- `src/core/types.ts` — 1266 lines / 44.2 KiB — BuildingKind:3, Terrain:15, Substrate:28, PlacementRule:29, …
...
- `src/main.ts` — 5783 lines / 211.8 KiB — currentBuild:144, dragOwnsPointer:455, loadHotbar:601, sanitiseSlot:629, …
...
- `src/ui/skills.ts` — 210 lines / 8.8 KiB — skillView:56, SkillsView:80
...
- `src/ui/worldParameters.ts` — 586 lines / 21.0 KiB — WorldScalar:19, NOISE_MAX:22, BAND_KEYS:24, BAND_GAP:31, …
