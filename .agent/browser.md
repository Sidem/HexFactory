...
- `src/core/saveSlots.ts` — 805 lines / 25.9 KiB — SAVE_VERSION:48, SAVE_CATALOG_KEY:49, LEGACY_SAVE_PREFIX:50, HXF1_PREFIX:51, …
- `src/core/skills.ts` — 114 lines / 4.3 KiB — validateSkills:4
- `src/core/snapshotDelta.ts` — 139 lines / 4.9 KiB — applySnapshotDelta:14, applyBuildingsPatch:51, applyResourcesPatch:88, applyTerrainPatch:106, …
- `src/core/snapshotWire.ts` — 818 lines / 25.7 KiB — Reader:153, decodeSnapshotDelta:230, readPlayer:456, readChunks:519, …
- `src/core/terrain.ts` — 169 lines / 5.3 KiB — TerrainInfo:13, TERRAIN_INFO:23, TERRAIN_ORDER:89, WADE_LIMIT_QUANTA:100, …
- `src/core/types.ts` — 1319 lines / 45.6 KiB — BuildingKind:3, Terrain:15, Substrate:28, PlacementRule:29, …
...
- `src/ui/groundBrush.ts` — 100 lines / 3.1 KiB — GroundBrushMode:3, movesEarth:15, takesGroundwork:20, BrushHex:23, …
