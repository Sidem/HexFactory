...
- `src/core/saveSlots.ts` — 799 lines / 26.3 KiB — SAVE_VERSION:44, SAVE_CATALOG_KEY:45, LEGACY_SAVE_PREFIX:46, HXF1_PREFIX:47, …
- `src/core/skills.ts` — 114 lines / 4.4 KiB — validateSkills:4
...
- `src/main.ts` — 5856 lines / 215.0 KiB — currentBuild:144, dragOwnsPointer:454, loadHotbar:600, sanitiseSlot:628, …
