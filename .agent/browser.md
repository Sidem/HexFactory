...
- `src/core/saveSlots.ts` — 799 lines / 25.5 KiB — SAVE_VERSION:44, SAVE_CATALOG_KEY:45, LEGACY_SAVE_PREFIX:46, HXF1_PREFIX:47, …
...
- `src/core/types.ts` — 1293 lines / 45.0 KiB — BuildingKind:3, Terrain:15, Substrate:28, PlacementRule:29, …
...
- `src/ui/skills.ts` — 224 lines / 9.4 KiB — skillView:70, SkillsView:94
