...
- `src/contact/main.ts` — 251 lines / 8.3 KiB — paint:62, repaint:78, element:82, …
...
- `src/core/snapshotWire.ts` — 892 lines / 28.2 KiB — Reader:159, decodeSnapshotDelta:236, readPlayer:509, …
- `src/core/terrain.ts` — 185 lines / 6.0 KiB — TerrainInfo:13, TERRAIN_INFO:23, TERRAIN_ORDER:104, …
- `src/core/types.ts` — 1402 lines / 47.5 KiB — BuildingKind:3, Terrain:15, Substrate:29, …
