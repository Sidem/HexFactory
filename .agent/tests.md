...
- `factory-wasm/src/tests/earthworks.rs` — 1166 lines / 44.2 KiB — disc_offsets:4, set_test_footprint:22, set_test_envelope:31, set_test_clearance:40, …
...
- `factory-wasm/src/tests/player.rs` — 635 lines / 26.7 KiB — movement_intent_aim_and_cadence_are_native:4, swimming_is_a_learned_deep_water_route_and_not_a_building_rule:188, a_click_routes_walks_and_replans_around_what_blocks_it:221, gathering_is_bounded_by_reach_cooldown_and_what_the_hex_holds:453
...
- `factory-wasm/src/tests/throughput.rs` — 202 lines / 10.3 KiB — capacity_workload_is_deterministic_and_actually_produces:4, capacity_is_measured_per_phase_and_per_tier_against_a_supplied_clock:68
...
- `tests/host.test.ts` — 2019 lines / 75.6 KiB — fakeTransport:1772
