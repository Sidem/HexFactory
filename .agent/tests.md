...
- `factory-wasm/src/tests/earthworks.rs` — 1170 lines / 44.6 KiB — disc_offsets:4, set_test_footprint:22, set_test_envelope:31, set_test_clearance:40, …
...
- `factory-wasm/src/tests/throughput.rs` — 206 lines / 10.8 KiB — capacity_workload_is_deterministic_and_actually_produces:4, capacity_is_measured_per_phase_and_per_tier_against_a_supplied_clock:72
