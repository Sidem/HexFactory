...
- `factory-wasm/src/tests/construction.rs` — 932 lines / 38.1 KiB — placement_and_drag_build_exactly_what_the_rules_allow_and_undo_takes_it_back:4, occupied_footprints_suppress_only_the_fertile_riverbank_cells_they_cover:329, creative_unlocks_grants_resizes_and_survives_a_save:357, erasing_refunds_spills_and_never_leaves_an_uncompilable_graph:515, …
...
- `factory-wasm/src/tests/earthworks.rs` — 1259 lines / 47.7 KiB — disc_offsets:4, set_test_footprint:22, set_test_envelope:31, set_test_clearance:40, …
...
- `factory-wasm/src/tests/machines.rs` — 1140 lines / 48.2 KiB — machines_draw_on_the_stock_and_terrain_beside_them_and_flora_grows_back:8, a_machine_runs_only_its_own_category_and_is_reassigned_only_between_crafts:210, a_cancelled_craft_returns_its_reserved_inputs_and_leaves_fuel_and_output_alone:271, skills_are_finite_atomic_and_isolated_from_research:336, …
...
- `factory-wasm/src/tests/save.rs` — 534 lines / 23.2 KiB — a_pre_physical_save_is_refused_with_an_export_offered:10, a_save_resumes_and_replays_in_a_deterministic_order:15, fertile_riverbank_is_rebuilt_exactly_and_never_enters_the_save_or_checksum:113, surveying_publishes_only_the_new_chunks_bounded_habitat_patch:133, …
- `factory-wasm/src/tests/stock.rs` — 945 lines / 37.6 KiB — the_pack_is_a_slot_rule_that_transport_erasure_and_withdrawal_all_obey:16, stock_moves_between_hand_machine_and_container_without_leaving_native_state:276, an_upgrade_preserves_contents_and_reach_storing_and_gathering_stay_bounded:501, dropped_items_land_are_picked_up_despawn_and_survive_a_save:770, …
...
- `factory-wasm/src/tests/wire_format.rs` — 767 lines / 28.6 KiB — entity_status_spellings_are_what_the_host_renders:51, hex_encode:63, wire_fixture_cases:70, the_cross_language_fixtures_pin_the_format_and_the_economy:694
...
- `tests/guidance.test.ts` — 532 lines / 17.9 KiB — shippedScenario:29, boardFor:50, snapshotAt:79
- `tests/habitat.test.ts` — 110 lines / 3.1 KiB
...
- `tests/visualDepth.test.ts` — 2020 lines / 68.1 KiB — surfaceBody:1728, uniformValue:1734, compileTerrain:1744, cliffTile:1759, …
